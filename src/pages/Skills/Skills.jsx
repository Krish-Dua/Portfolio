  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Express",
          icon: <SiExpress className="w-4 h-4 text-[#00ff00]" />,
        },
        {
          name: "PostgreSQL",
        ...
        {
          name: "MySQL",
          icon: <SiMysql className="w-4 h-4 text-[#00ff04]" />,
        },
        {
          name: "REST APIs",
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Github",
          icon: <SiGithub className="w-4 h-4 text-[#F05032]" />,
        },
        {
          name: "Docker",
        ...
        {
          name: "Postman",
          icon: <SiPocket className="w-4 h-4 text-[#2496ED]" />,
        },
        {
          name: "Render",
          icon: <SiRender className="w-4 h-4 text-[#2496ED]" />,
        },
        {
          name: "Redux",
        ...
        {
          name: "Cloudinary",
          icon: <SiCloudinary className="w-4 h-4 text-[#4a57bc]" />,
        },
        {
          name: "Vite",
