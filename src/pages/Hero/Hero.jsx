...
export default function Hero() {
  const words = [
    ...
    "MERN Stack & Real-Time App Builder",
    "AI-Integrated Web Applications",
    "Exploring Systems & Modern Web Architecture",
  ];
  const [code] = useState(`
const profile = {
    name: 'Krish Dua',
    title: 'Full-Stack Developer | MERN Stack & Scalable Systems',
    skills: [
        'React','Node.js','Express',
        'MongoDB','SQL','JavaScript','Tailwind CSS',
        'Zustand','WebSockets','Git','Linux'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
    ...
    <>
      <main className="bg-[#020617] text-white min-h-screen">
        <section className="hero min-h-screen flex items-center justify-center relative px-4 sm:px-6 lg:px-8 py-10 md:py-16 lg:py-0 hero-section-padding">
          ...
          {}
          <div
            className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-2 md:py-10 lg:py-12 md:pt-0 xl:pt-18"
            style={{
              paddingTop:
                window.innerWidth >= 1360 &&
                window.innerWidth <= 1370 &&
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  ...
                  Passionate about designing clean, maintainable code and
                  creating interactive user experiences that solve real-world
                  problems.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                {}
                <a
                  href="https://github.com/krish-dua"
              ...
              <div className="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float">
                <div className="px-4 py-2 rounded-lg bg-amber-500/10 backdrop-blur-sm border border-amber-500/20 text-amber-400">
                  <i className="fas fa-lightbulb"></i>&nbsp;&nbsp;Performance
                  focused
                </div>
              </div>
            </div>
